...
namespace Simulation {
  ...
  const unsigned int TimeSteps_Between_Prints    = 10000;

  // TimeStep paramters
  const double dt                                = .00000005;         // Time step        : s
  const unsigned int Num_Steps                   = 2000000;         // Number of time steps
